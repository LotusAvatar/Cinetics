...
public class JointOverlayerColorVsWords : MonoBehaviour
{
    ...
    private static JointOverlayerColorVsWords instance;
    /// <summary>
    /// Gets the single JointOverlayerColorVsWords instance.
    /// </summary>
    /// <value>The JointOverlayerColorVsWords instance.</value>
    public static JointOverlayerColorVsWords Instance
    {
        get
        {
            if (instance == null)
            {
                instance = (JointOverlayerColorVsWords)GameObject.FindObjectOfType(typeof(JointOverlayerColorVsWords));
            }
            return instance;
        }
    }
