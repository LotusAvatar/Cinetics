...
public class JointOverlayerColorCubes : MonoBehaviour
{
    ...
    [Tooltip("Variable used to multiply the movement sensibility")]
                ...
                if (manager.IsJointTracked(userId, iJointIndex))
                {
                    ...
                    if (posJoint != Vector3.zero)
                    {
                        ...
                        if (overlayObject)
                        {
                            ...
                            float jointDepth = overlayObject.position.z;
                            posJoint *= sensibility;
                            posJoint.z = jointDepth;
